...
import com.skjolberg.nfc.refactor.BaseFragmentActivity;
...
public abstract class NfcDetectorFragmentActivity extends BaseFragmentActivity {
	
    private static final String TAG = NfcDetectorFragmentActivity.class.getName();
